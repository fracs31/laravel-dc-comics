...
class ComicsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($comics as $comic) {
            ...
            $newComic->title = $comic["title"]; //titolo
            $newComic->description = $comic["description"]; //descrizione
            $newComic->thumb = $comic["thumb"]; //copertina
            $newComic->price = $comic["price"]; //prezzo
            $newComic->series = $comic["series"]; //serie
            $newComic->sale_date = $comic["sale_date"]; //data di uscita
            $newComic->type = $comic["type"]; //tipo
